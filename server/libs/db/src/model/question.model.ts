import { ModelOptions ,prop, Ref, Post, buildSchema, getModelForClass} from "@typegoose/typegoose";
...
export class Question{
    ...
    @prop({ref:'Course',localField:'course_id',foreignField:'_id',justOne:true})
    course:Ref<Course>
    @ApiProperty()
    @prop()
    course_id:string
