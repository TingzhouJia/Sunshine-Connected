...
export type QueryList<T> = DocumentQuery<
  Array<DocumentType<T>>,
  DocumentType<T>
>;
export type QueryItem<T> = DocumentQuery<DocumentType<T>, DocumentType<T>>;
...
export abstract class BaseRepository<T> {
  constructor(private model: ReturnModelType<AnyParamConstructor<T>>) {}
   ...
   */
  public async create(docs: any): Promise<DocumentType<T>> {
    try {
