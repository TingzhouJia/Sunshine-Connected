...
export class QuestionRepository extends BaseRepository<Question> {
  constructor(
    ...
    private readonly _model: ReturnModelType<typeof Question>,
  ) {
    super(_model);
  }
  ...
  async getQuestionListByUserId(
    id: string,
    pagination: PaginationParams<Question>,
  ) {
    return await super.paginator(
      { ...pagination, query: { author_id: id } },
      '-answer',
      {
        populates: [
          {
  ...
  //without pagination
  async getQuestionListByVideoId(
    id: string,
    pagination: PaginationParams<Question>,
  ) {
    return await super.paginator(
      { ...pagination, query: { course_id: id } },
      '',
