...
export const SideMenu = () => {
    ...
    return (
        <>
            ...
            <Menu mode="inline" theme={'light'} defaultSelectedKeys={[`${router.pathname}`]} selectedKeys={[`${router.route.split('/')[1]}`]}>
                <Menu.ItemGroup key="buddy_system" title={<NavTitle>{t('buddy_system')}</NavTitle>}>
                    <Menu.Item key="poll">
